...
export default function Edit({ auth, puppy }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        image: null,
        _method: 'put' // For Inertia file upload support via POST
    });

    const [imagePreview, setImagePreview] = useState(puppy.image ? `/storage/${puppy.image}` : null);
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="font-bold text-2xl text-gray-800 leading-tight">Edit Puppy: {puppy.name}</h2>
                </div>
            }
        >
            <Head title={`Edit ${puppy.name}`} />
                    ...
                    <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                        <form onSubmit={submit} className="space-y-8" encType="multipart/form-data">
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4">
                                ...
                                <p className="text-sm text-gray-500 text-center">Click to upload a new picture<br/>(JPG, PNG, max 2MB)</p>
                            ...
                            <div className="flex items-center justify-end pt-6 border-t border-gray-100">
                                ...
                                >
                                    ...
                                    {processing ? 'Saving...' : 'Update Puppy'}
                                </button>
                            </div>
                        </form>
                    </div>
